package link.srrrg.auth.login.model;
 ...
 */
public record ProviderProfile(String email, boolean emailVerified, String displayName) {

	/**
	 * Google은 최상위에 {@code email}과 {@code email_verified}를 준다.
	 * 이메일이 없으면 검증 여부도 의미가 없으므로 함께 거짓으로 만든다.
	 */
	public static ProviderProfile google(Map<String, Object> attributes) {
	 ...
	 */
	public static ProviderProfile kakao(Map<String, Object> attributes) {
	 ...
	 */
	public static ProviderProfile github(Map<String, Object> attributes, String verifiedEmail) {
