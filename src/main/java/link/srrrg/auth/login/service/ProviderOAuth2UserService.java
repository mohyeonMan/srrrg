...
import link.srrrg.auth.login.client.GitHubEmailClient;
import link.srrrg.auth.login.model.ProviderProfile;
...
public class ProviderOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
