...
import link.srrrg.auth.login.service.OAuthProfileFactory;
...
import link.srrrg.identity.connection.service.OAuthAccountLinkService.PendingLink;
...
public class OAuthLoginSuccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			LoginResolution resolution = loginCompletionService.complete(identity);
