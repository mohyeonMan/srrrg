package link.srrrg.link.risk.google.client;
 ...
 */
public final class SafeBrowsingProtobufDecoder {
	 ...
	 */
	public static Response decode(byte[] body) throws IOException {
	...
	public record Response(int threatCount, Duration cacheDuration) {
	}
}
