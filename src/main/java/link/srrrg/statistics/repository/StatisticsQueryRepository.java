package link.srrrg.statistics.repository;

import link.srrrg.link.access.model.LinkAccessEvent;
import link.srrrg.statistics.dto.StatisticsResponse;
import link.srrrg.statistics.model.StatisticsPeriod;
import link.srrrg.statistics.model.StatisticsQueryScope;
...
import link.srrrg.link.access.model.LinkAccessEvent.Outcome;
import link.srrrg.statistics.dto.StatisticsResponse.Breakdown;
import link.srrrg.statistics.dto.StatisticsResponse.CampaignRow;
import link.srrrg.statistics.dto.StatisticsResponse.DestinationSource;
import link.srrrg.statistics.dto.StatisticsResponse.LinkActivityStatus;
import link.srrrg.statistics.dto.StatisticsResponse.LinkRow;
import link.srrrg.statistics.dto.StatisticsResponse.OutcomeBreakdown;
import link.srrrg.statistics.dto.StatisticsResponse.PageResult;
import link.srrrg.statistics.dto.StatisticsResponse.PeriodMetrics;
import link.srrrg.statistics.dto.StatisticsResponse.RecentActivity;
import link.srrrg.statistics.dto.StatisticsResponse.TrendPoint;
import link.srrrg.statistics.dto.StatisticsResponse.UtmRow;
...
public class StatisticsQueryRepository {
	...
	public StatisticsQueryRepository(JdbcTemplate jdbc) { this.jdbc = jdbc; }

	public TotalsWindow totals(StatisticsQueryScope scope, StatisticsPeriod period) {
		String sql = """
				SELECT
	...
	public long[] lifetimeLinkSummary(StatisticsQueryScope scope) {
		String sql = """
				SELECT COUNT(*),
	...
	public List<RawTrendPoint> trend(StatisticsQueryScope scope, StatisticsPeriod period, StatisticsResponse.Bucket bucket) {
	...
	public List<OutcomeBreakdown> outcomes(StatisticsQueryScope scope, StatisticsPeriod period) {
	...
	public List<Breakdown> breakdown(StatisticsQueryScope scope, StatisticsPeriod period, Dimension dimension) {
	...
	public List<RecentActivity> recent(StatisticsQueryScope scope, StatisticsPeriod period) {
	...
	public PageResult<LinkRow> campaignLinks(long campaignId, StatisticsPeriod period, int offset, int limit) {
		String sql = """
	...
	public PageResult<UtmRow> campaignUtm(long campaignId, StatisticsPeriod period, int offset, int limit) {
		String sql = """
	...
	public PageResult<CampaignRow> projectCampaigns(long projectId, StatisticsPeriod period, int offset, int limit) {
		String sql = """
	...
	public enum Dimension { REFERRER, DEVICE, BROWSER, OPERATING_SYSTEM }
	public record TotalsWindow(PeriodMetrics current,PeriodMetrics previous) { }
	public record RawTrendPoint(LocalDate date,long entries,long redirects,long humanEntries,long humanRedirects,long botEntries,long botRedirects) {
		public TrendPoint toResponse() { return new TrendPoint(date,entries,redirects,humanEntries,humanRedirects,botEntries,botRedirects); }
	}
