...
public class ProjectController {
	...
	public record ProjectLinkResponse(String code, String subdomain, String originalUrl, Instant expiresAt, long accessCount, long redirectCount) { static ProjectLinkResponse from(Link link) { return new ProjectLinkResponse(link.getCode(), link.getSubdomain(), link.getOriginalUrl(), link.getExpiresAt(), link.getAccessCount(), link.getRedirectCount()); } }
