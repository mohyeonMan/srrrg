...
import link.srrrg.campaign.link.csv.model.CampaignImportRow;
import link.srrrg.campaign.link.csv.model.CampaignImportRowUtmValue;
import link.srrrg.campaign.link.csv.model.ImportRowStatus;
import link.srrrg.campaign.link.csv.model.ImportStatus;
import link.srrrg.campaign.link.csv.repository.CampaignImportRepository;
import link.srrrg.campaign.link.csv.repository.CampaignImportRowRepository;
import link.srrrg.campaign.link.csv.repository.CampaignImportRowUtmValueRepository;
...
public class CampaignImportProcessor {
	...
	public CampaignImportProcessor(CampaignImportRepository imports, CampaignImportRowRepository importRows,
			CampaignImportRowUtmValueRepository importRowUtmValues, LinkCreationService linkCreation) {
	...
	public void processRow(Long importId, Long rowId) {
		...
		try {
			...
			var createdLink = linkCreation.createForCampaign(row.getOriginalUrl(), null, campaign.getProject(),
					null, null, null, null,
