(function () {
	...
	const query = new URLSearchParams(location.search); const projectId = query.get('projectId'); const campaignId = query.get('campaignId');
